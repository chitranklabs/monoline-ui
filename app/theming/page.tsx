	...
	const jsonLd = {
		...
		"@graph": [
			...
			createBreadcrumbJsonLd([
				...
				{ name: displayTitle, path: "/theming" },
			]),
		],
	}
			...
			<main id="main-content" tabIndex={-1} className="docs-page">
				...
				<header className="docs-page__head">
					...
					<p>
						...
						once, then change those variables when your product needs a
						different voice.
					</p>
				</header>
				...
				<div className="docs-section">
					<Callout variant="tip" label="System preference">
						...
						root element to use the package&apos;s prefers-color-scheme
						fallback. An explicit theme always wins.
					</Callout>
				</div>
