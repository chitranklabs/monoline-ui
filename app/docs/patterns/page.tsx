		...
		<main id="main-content" tabIndex={-1} className="docs-page">
			...
			<section className="docs-section" aria-labelledby="recipes-title">
				<div className="docs-subhead">
					...
					<p>
						Each recipe links to the component that carries the main interaction
			...
			<section className="docs-section" aria-labelledby="index-title">
				<div className="docs-subhead">
					...
					<p>
						...
						The card contains one destination, so its title and summary describe
						that page.
					</p>
				</div>
				<CodeBlock
			...
			<div className="docs-section">
				<Callout variant="note" label="Choose the smallest pattern">
					A static list does not need client state. Add filters, disclosure, or
					async behavior only when the reader can use it to complete a task.
				</Callout>
			</div>
		</main>
	)
