	...
	const jsonLd = {
		...
		"@graph": [
			...
			createBreadcrumbJsonLd([
				...
				{ name: displayTitle, path: "/accessibility" },
			]),
		],
	}
			...
			<main id="main-content" tabIndex={-1} className="docs-page">
				...
				<div className="docs-section">
					<Callout variant="note" label="Scope, not certification">
						This page documents implemented behavior. It is not a claim that
						every interface assembled with Monoline automatically conforms to
						WCAG.
					</Callout>
				</div>
						...
						<Card>
							<Card.Body>
								...
								<Card.Description lines={4}>
									The theme applies one token-backed focus ring to links,
									buttons, inputs, selects, textareas, and explicit tabindex
									targets.
								</Card.Description>
							</Card.Body>
						</Card>
				...
				<section className="docs-section" aria-labelledby="consumer-title">
					<div className="docs-subhead">
						...
						<p>
							A reusable component cannot infer the meaning of an icon or
					...
					<ul className="guide-page__checklist">
						...
						<li>
							Keep headings in document order and use landmarks for page
							regions.
						</li>
