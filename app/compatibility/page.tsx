...
// The root barrel is client-safe because it also exports interactive components.
// Use narrow subpaths to preserve a Server Component boundary.`
	...
	const jsonLd = {
		...
		"@graph": [
			...
			createBreadcrumbJsonLd([
				...
				{ name: displayTitle, path: "/compatibility" },
			]),
		],
	}
		...
		<DocsShell>
			<main id="main-content" tabIndex={-1} className="docs-page">
				...
				<header className="docs-page__head">
					...
					<h1>{displayTitle}</h1>
					<p>
						The published package targets modern React applications. This page
						separates declared support from assumptions you should verify in
						your own browser and build matrix.
					</p>
				</header>

				<section className="docs-section" aria-labelledby="runtime-title">
					<div className="docs-subhead">
						<h2 id="runtime-title">Framework and build support</h2>
					</div>
				...
				<div className="docs-section">
					<Callout variant="warn" label="Before upgrading">
						Run your application build, typecheck, component tests, and key
						visual flows. A peer range confirms install compatibility; it cannot
						cover every bundler plugin or application override.
					</Callout>
				</div>
			</main>
		</DocsShell>
